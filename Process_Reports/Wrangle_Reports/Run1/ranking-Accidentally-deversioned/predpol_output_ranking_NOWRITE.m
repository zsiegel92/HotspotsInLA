...
for i = 1:21
    ...
    filename2 = ['Predpol/input/',num2str(i),divNames{i},'.csv'];
    fid = fopen(filename2);
...
save('ranking_spacetime_guide.mat','binClarity','binLabels','dates','divNames','drivers','gridlats','gridlons','rankingsByDivision');