% load('Process_Arrests/Mat_Files/Run2/loaded_arrests.mat');
% load('Process_Reports/Mat_Files/Run2/ranking_spacetime_guide.mat');
...
save('Process_Arrests/Mat_Files/Run2/minDistFromTopK_rem_badgeocode.mat')
